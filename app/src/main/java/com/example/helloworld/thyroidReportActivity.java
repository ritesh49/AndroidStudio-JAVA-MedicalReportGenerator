...
public class thyroidReportActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thyroid_report);
        getSupportActionBar().setTitle("THYROID REPORT");

        Intent intent=getIntent();
        String[] thyReports=intent.getStringArrayExtra("thyroidDetails");
        ...
        TextView tv11=findViewById(R.id.t3View);
        tv11.setText(thyReports[4]);
        TextView tv12=findViewById(R.id.t4View);
        tv12.setText(thyReports[5]);
        TextView tv13=findViewById(R.id.tshView);
        tv13.setText(thyReports[6]);
    }
}
